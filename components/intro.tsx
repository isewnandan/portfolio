...
export default function Intro() {
  ...
  return (
    <section ref={ref} id="home" className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]">
        ...
        <motion.h1 
        className="mb-10 mt-4 px-4 text-2x1 front-medium !leading-[1.5] sm:text-4x1"
        initial={{ opacity: 0, y: 100 }}
        animate={{ opacity: 1, y: 0 }}>
        <span className="font-bold">Hello, I'm Ishan Sewnandan.</span> I'm a{" "}
        <span className="font-bold">dedicated student</span> with{" "}
        <span className="font-bold">2 years</span> of experience in web development, and I'm now 
        <span className="italic"> expanding my skills</span>. as a{" "}
        <span className="underline">Data analyst (Data science)</span>
        </motion.h1>
        ...
        transition={{
          ...
          <a className="bg-white p-4 text-gray-700 flex hover:text-gray-950 items-center gap-2 rounded-full focus:scale-[1.15] hover:scale-[1.15]
          active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://www.linkedin.com/in/isewnandan" target="_blank">
            <BsLinkedin />
          </a>
          ...
          href="https://github.com/isewnandan" target="_blank">
            <FaGithubSquare />
          </a>
        </motion.div>
    </section>
